...
exports.shouldSuggest = (lineText, cursorPosition) => {
    if (/def test_/.test(lineText)) {
        ...
        //   lineText.length
        // );
        if (lineTillCurrentPosition.indexOf("(") > -1 &&
