...
class ErlangDebugAdapterExecutableFactory {
    ...
    createDebugAdapterDescriptor(_session, _executable) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const command = erlangConfig.getConfiguration('erlang_ls').get('escriptPath') || 'escript';
            let args;
            if (executable.length > 0) {
                ...
                // use default
                args = [this.context.asAbsolutePath(path.join('els_dap', '_build', 'default', 'bin', 'els_dap'))];
            }
