...
function get_client(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let escriptPath = vscode_1.workspace.getConfiguration('erlang_ls').escriptPath;
        if (escriptPath === "") {
            escriptPath = 'escript';
        }
        let serverOptions = {
...
function verifyExecutable(serverPath, escriptPath) {
    const res = (0, child_process_1.spawnSync)(escriptPath, [serverPath, "--version"]);
    if (res.status !== 0) {
